...
mixin _$LoginState on _LoginState, Store {
  ...
  bool get loggingIn => (_$loggingInComputed ??=
      ...
      .value;
  Computed<bool>? _$lembrarSeComputed;

  @override
  bool get lembrarSe => (_$lembrarSeComputed ??=
          Computed<bool>(() => super.lembrarSe, name: '_LoginState.lembrarSe'))
      .value;
  ...
  late final _$_lembrarSeAtom =
      Atom(name: '_LoginState._lembrarSe', context: context);

  @override
  bool get _lembrarSe {
    _$_lembrarSeAtom.reportRead();
    return super._lembrarSe;
  }

  @override
  set _lembrarSe(bool value) {
    _$_lembrarSeAtom.reportWrite(value, super._lembrarSe, () {
      super._lembrarSe = value;
    });
  }
  ...
  void setLembrarSe({required bool value}) {
    final _$actionInfo = _$_LoginStateActionController.startAction(
        name: '_LoginState.setLembrarSe');
    try {
      return super.setLembrarSe(value: value);
    } finally {
      _$_LoginStateActionController.endAction(_$actionInfo);
    }
  }
